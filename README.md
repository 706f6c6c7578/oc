...
oc_guard_server.go uses [minicrypt](https://github.com/706f6c6c7578/minicrypt) to decrypt incoming data, prior it sends to middlemen.    The accepted message size for a Guard is limited to 28 KB.    
