...
func handleUpload(w http.ResponseWriter, r *http.Request) {
	...
	// Call the sendArticle function (previously in pn.go)
	err = sendArticle(reader)
	if err != nil {
		log.Println("Error sending article:", err)
		http.Error(w, "Error sending article", http.StatusInternalServerError)
		return
	}
	...
	fmt.Fprintf(w, "File %s received and sent!", header.Filename)
}
