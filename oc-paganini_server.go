...
func sendArticle(reader io.Reader) (string, error) {
	...
	sessionLog.WriteString("Client: POST\r\n")
	response, err = bufReader.ReadString('\n')
	if err != nil {
	...
	sessionLog.WriteString("Client: [Article content not logged]\n")
	...
	sessionLog.WriteString("Client: QUIT\r\n")
